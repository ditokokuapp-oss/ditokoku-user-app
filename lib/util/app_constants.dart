...
class AppConstants {
  static const String appName = 'ditokoku';
  static const double appVersion = 3.2; ///Flutter sdk 3.32.5

  static const String fontFamily = 'Poppins';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://www.ditokoku.id';
  static const bool useReactWebsite = true;

  static const String baseUrl = 'https://dash.ditokoku.id';
  // static const String baseUrl = 'https://staging.ditokoku.id';
  ...
  static const String addLoyaltyPointUri = '/api/v1/customer/loyalty-point/add-points';
  ...
  static const String deductFundUri = '/api/v1/customer/wallet/deduct-fund';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.id, languageName: 'Indonesia', countryCode: 'ID', languageCode: 'id'),
    LanguageModel(imageUrl: Images.english, languageName: 'Inggris', countryCode: 'US', languageCode: 'en'),
