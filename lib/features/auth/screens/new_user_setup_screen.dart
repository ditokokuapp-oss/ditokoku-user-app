        ...
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              ...
              SizedBox(height: (Get.find<SplashController>().configModel!.refEarningStatus == 1 ) ? Dimensions.paddingSizeExtraOverLarge : Dimensions.paddingSizeExtraLarge),

              GetBuilder<AuthController>(builder: (authController) {
                return CustomButton(
                  buttonText: 'Simpan',
                  radius: Dimensions.radiusDefault,
                  color: const Color(0xFF5EC1B2),
                  isBold: true,
