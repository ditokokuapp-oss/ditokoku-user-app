...
import 'package:sixam_mart/features/verification/screens/custom_verification_screen.dart';
...
class RouteHelper {
  ...
  static const String popularItems = '/popular-items';
   static const String customVerification = '/custom-verification';
  ...
  static String getCustomVerificationRoute(String phoneNumber) {
    return '$customVerification?phone=${Uri.encodeComponent(phoneNumber)}';
  }
...
GetPage(name: customVerification, page: () {
  final phoneNumber = Get.parameters['phone'] ?? '';
  return CustomVerificationScreen(phoneNumber: phoneNumber);
}),
